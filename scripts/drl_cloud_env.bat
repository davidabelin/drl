...
set "CANONICAL_DRL_URL=https://drl-web-x2ulcmhaiq-wm.a.run.app"
set "APPSPOT_ALIAS_URL=https://deeprl-031026.wm.r.appspot.com"
set "CREDS_PATH=C:\Users\David\Documents\Local_Data\creds"
set "GOOGLE_APPLICATION_CREDENTIALS=%CREDS_PATH%\deeprl-031026-dc9a9d98c6c6.json"
set "RUN_MEMORY=1Gi"
set "RUN_CPU=1"
exit /b 0
